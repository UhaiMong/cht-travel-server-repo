    ...
    try {
        ...
        app.post("/init", async (req, res) => {
            const data = {
                ...
                tran_id: "REF123",
                success_url:
                    "https://cht-travel-server-production.up.railway.app/success",
                fail_url: "https://cht-travel-server-production.up.railway.app/fail",
                cancel_url:
                    "https://cht-travel-server-production.up.railway.app/cancel",
                ipn_url: "https://cht-travel-server-production.up.railway.app/ipn",
